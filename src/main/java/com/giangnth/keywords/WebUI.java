...
public class WebUI {
    ...
    public static WebElement waitForElementVisible(By by){
        ...
        try {
            //LogUtils.info("Driver in WebUI: " +driver);
    ...
    public static WebElement waitForElementVisible(By by, int seconds){
        ...
        try{
            ...
            LogUtils.error("Timeout waiting for the element Visible with " + seconds + "(s) : "+ by.toString());
    ...
    public static List<WebElement> waitForAllElementsVisible(By by) {
        ...
        try {
            ...
            LogUtils.error("Timeout waiting for all elements to be visible. " + by.toString());
    ...
    public static WebElement waitForElementClick(By by, int seconds){
        ...
        try {
            ...
            LogUtils.error("Timeout waiting for the element clickable with " + seconds + "(s) : "+ by.toString());
    ...
    public static WebElement waitForElementPresent(By by, int seconds){
        ...
        try {
            ...
            LogUtils.error("Element not exit with " + seconds + "(s) : "+ by.toString());
            Assert.fail("Timeout waiting for the element clickable with " + seconds + "(s) : "+ by.toString());
        }
        return element;
    }
    ...
    public static WebElement waitForElementPresent(By by){
        ...
        try {
            ...
            LogUtils.error("Element not exit" + by.toString());
    ...
    public static boolean checkExitsElement(By by) {
        ...
        if (elements.size() > 0) {
            LogUtils.info("Phần tử tồn tại: true " + by);
            return true;
        } else {
            LogUtils.error("Phần tử tồn tại: false " + by);
            return false;
        }
    }
    ...
    public static boolean checkSeletedElement(By by) {
        ...
        if (element.isSelected()) {
            LogUtils.info("Phần tử đã tích chọn: true " + by);
            return true;
        } else {
            LogUtils.info("Phần tử không tích chọn: false " + by);
            return false;
        }
    }
